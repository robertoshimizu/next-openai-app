...
const navigation = [
  ...
  { name: 'completion', href: 'completion' },
  { name: 'fastapi', href: 'fastapi' },
  { name: 'function-calling', href: 'function-calling' },
  { name: 'openai-functions-agent', href: 'openai-functions-agent' },
  ...
  { name: 'spell-check', href: 'spell-check' },
  { name: 'stream-react-response', href: 'stream-react-response' },
